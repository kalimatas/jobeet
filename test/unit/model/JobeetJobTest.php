...
$job = create_job();
$job->save();
$expires_at = date('Y-m-d', time() + 86400 * sfConfig::get('app_active_days'));
$t->is($job->getDateTimeObject('expires_at')->format('Y-m-d'), $expires_at, '->save() updates expires_at if not set');
